        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-10 h-10 bg-gradient-to-r from-accent to-accent-dark rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-xl">E</span>
              </div>
              <span className="text-2xl font-bold text-white">EstateHub</span>
            </div>
            <p className="text-sm text-gray-400">
              Your trusted partner in finding the perfect property across North India and major metros.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                ...
                <span>estatesupport@gmail.com</span>
