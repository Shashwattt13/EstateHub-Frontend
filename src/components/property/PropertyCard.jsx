  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        {/* Price */}
        <div className="mb-2">
          <span className="text-2xl font-bold text-textc-primary">
        ...
        {/* Title */}
        <h3 className="text-lg font-semibold text-textc-primary mb-2 line-clamp-2 group-hover:text-primary transition-colors">
          {property.title}
        </h3>

        {/* Location */}
        <div className="flex items-center text-textc-secondary text-sm mb-3">
        ...
        {/* Stats */}
        <div className="flex items-center justify-between text-textc-secondary text-sm border-t border-gray-100 pt-3">
